...
export const Inventory: React.FC = () => {
    ...
    // Click outside to close Data Tools
    useEffect(() => {
                    ...
                    <div className="relative" ref={dataToolsRef}>
                        ...
                        {showDataTools && (
                            <div className="absolute top-full right-0 mt-2 w-48 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg shadow-xl z-50 animate-in zoom-in-95 origin-top-right">
                                ...
                                <button onClick={() => { fileInputRef.current?.click(); setShowDataTools(false); }} className="block w-full text-left px-4 py-2 hover:bg-slate-50 dark:hover:bg-slate-700 text-xs text-slate-700 dark:text-slate-200 flex items-center gap-2">
