...
export const Login: React.FC<LoginProps> = ({ onLogin }) => {
    ...
    const handleDemoLogin = (role: string) => {
        const demoCreds: { [key: string]: { e: string, p: string } } = {
            'Admin': { e: 'admin@hanuman.com', p: 'password123' }, // Corrected password based on demo credentials
            'Tenant1': { e: 'rajesh@tenant1.com', p: 'password123' } // Added tenant demo
        };
            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md">
                ...
                <div className="mt-8 pt-6 border-t border-slate-100">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <button
                            onClick={() => handleDemoLogin('Tenant1')}
